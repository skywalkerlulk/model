...
针对问题四，本文以任意拉格朗日--欧拉（ALE）移动网格谱配点处理半径收缩，结合附录 4 物性与附件 2 实测收缩曲线，解得收缩情形烘干时长 51.15 h，比固定半径情形缩短 6.68 h（11.6\%）；与独立物质坐标公式互证偏差仅 0.02 h，并给出收缩--失水一致性检验：早期收缩与失水线性相关、后期收缩趋于饱和。
